    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 text-xs font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full w-fit mb-2 border border-emerald-200">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Protótipo Oficial UX Master: Beatriz Brandão • Squad 4 (Mariana Siqueira)</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight flex items-center gap-3">
              <Pill className="w-8 h-8 text-emerald-600" />
              Farmácia Hospitalar &amp; Estoque Inteligente (FEFO)
            </h1>
            <p className="text-sm text-slate-600 mt-1">
              Primeiro que Vence, Primeiro que Sai (*First Expire, First Out*). Controle de validade e baixa automática integrada ao OpenBoxes e ao Custo Door-to-Door.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-xl transition-all shadow-md shadow-emerald-500/20"
            >
        ...
        {dispensationSuccess && (
          <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-xl flex items-center gap-3 text-emerald-800 text-sm font-medium animate-fadeIn">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-500">Itens em Estoque</span>
              <div className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center">
                <Package className="w-4 h-4" />
              </div>
            </div>
            <div className="text-2xl font-black text-slate-900 mt-2">2.345</div>
            <p className="text-xs text-slate-500 mt-1">100% catalogados no OpenBoxes</p>
          </div>

          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-rose-600">Alerta Crítico (&lt; 30 Dias)</span>
              <div className="w-8 h-8 rounded-lg bg-rose-50 text-rose-600 flex items-center justify-center">
                <ShieldAlert className="w-4 h-4" />
              </div>
            </div>
            <div className="text-2xl font-black text-rose-600 mt-2">3 Lotes</div>
            <p className="text-xs text-slate-500 mt-1">Prioridade máxima de uso para zero perda</p>
          </div>

          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-emerald-600">Economia FEFO Apurada</span>
              <div className="w-8 h-8 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center">
                <TrendingDown className="w-4 h-4" />
              </div>
            </div>
            <div className="text-2xl font-black text-emerald-700 mt-2">R$ 14.820,00</div>
            <p className="text-xs text-slate-500 mt-1">Desperdício zero por vencimento evitado</p>
          </div>

          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-500">Auditoria Teto CMED</span>
              <div className="w-8 h-8 rounded-lg bg-amber-50 text-amber-600 flex items-center justify-center">
                <DollarSign className="w-4 h-4" />
              </div>
            </div>
            <div className="text-2xl font-black text-slate-900 mt-2">100% Conforme</div>
            <p className="text-xs text-slate-500 mt-1">Nenhuma compra acima do preço teto</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
              <div className="relative w-full sm:w-72">
                ...
                <input
                  type="text"
                  placeholder="Buscar por remédio, lote ou código..."
                  value={searchTerm}
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                <select
                  ...
                  className="text-xs border border-slate-200 rounded-xl px-3 py-2 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                >
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col justify-between">
            {selectedLot ? (
              <div>
                ...
                <h3 className="text-lg font-black text-slate-900">{selectedLot.name}</h3>
                <p className="text-xs text-slate-500 mb-6">{selectedLot.dosage}</p>
                ...
                <div className="space-y-3.5 text-xs">
                  ...
                  <div className="flex justify-between py-2 border-b border-slate-100">
                    ...
                    <span className="font-black text-emerald-600">R$ {selectedLot.unitCost.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-slate-100">
                    <span className="text-slate-500">Preço Teto CMED (Governo)</span>
            ...
            <button
              ...
              className="mt-6 w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition-all shadow-md shadow-emerald-600/20 flex items-center justify-center gap-2"
            >
