...
export default function VigiaEstoqueCentralPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col font-sans">
      {/* ========================================================================= */}
      {/* 1. CABEÇALHO DO PRODUTO ÚNICO (ESTOQUE CENTRAL & ALMOXARIFADO WMS) */}
      {/* ========================================================================= */}
      <header className="sticky top-0 z-40 bg-white border-b border-[#E0E0E0] px-4 lg:px-6 h-16 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2 rounded-xl text-slate-600 hover:bg-[#F5F5F5] hover:text-slate-900 transition-all cursor-pointer focus:ring-2 focus:ring-amber-600 focus:outline-none"
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-[#D97706] flex items-center justify-center text-white shadow-xs">
              <Boxes className="w-5 h-5" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="text-sm font-bold text-slate-900 tracking-tight">Vigia Saúde</span>
                <span className="text-xs text-slate-500 font-medium hidden sm:inline">| Estoque Central &amp; Almoxarifado</span>
              ...
              <p className="text-[11px] text-slate-500 hidden md:block">
                Gestão e balanceamento de almoxarifados hospitalares, lotes FEFO e centro de distribuição
              </p>
            </div>
          </div>
        </div>

        {/* Lado Direito: Ações Rápidas do Módulo + Seletor de Perfil RBAC */}
        <div className="flex items-center gap-2.5">
          <button
            onClick={() => setSecaoAtiva('nfe')}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-[#D97706] text-white hover:bg-amber-700 transition-all shadow-xs cursor-pointer focus:ring-2 focus:ring-amber-500 focus:outline-none"
          >
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-slate-800 hover:bg-slate-900 text-white transition-all shadow-xs cursor-pointer focus:ring-2 focus:ring-slate-500 focus:outline-none"
          >
          ...
          <button
            ...
            className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-emerald-600 hover:bg-emerald-700 text-white transition-all shadow-xs cursor-pointer focus:ring-2 focus:ring-emerald-500 focus:outline-none"
          >
          ...
          <div className="w-8 h-8 rounded-xl bg-[#D97706] text-white flex items-center justify-center text-xs font-bold shadow-xs">
            MV
          </div>
        </div>
      </header>
