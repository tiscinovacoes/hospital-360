          ...
          <div className="space-y-6 animate-in fade-in duration-200">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-[#F3F4F6] gap-2">
                <div>
                  <h3 className="text-base font-bold text-[#111928] flex items-center gap-2">
                    <Receipt className="w-5 h-5 text-[#0891B2]" />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="p-5 bg-white rounded-2xl border border-[#E5E7EB] shadow-sm hover:border-[#1A56DB] transition-all flex flex-col justify-between group">
                  <div>
                    <div className="w-10 h-10 rounded-xl bg-blue-50 text-[#1A56DB] flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                  ...
                  <Link
                    href="/medico"
                    className="mt-4 w-full py-2 px-3 rounded-xl border border-[#1A56DB] text-[#1A56DB] hover:bg-[#1A56DB] hover:text-white font-bold text-xs text-center transition-colors block"
                  >
                    Prescrever Exames
                  </Link>
                </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="sm:text-right">
                      <span className="font-semibold text-[#1A56DB] flex items-center sm:justify-end gap-1.5">
              ...
              <div className="mt-6 p-6 bg-slate-50 border border-slate-200 rounded-2xl space-y-6">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-xl font-mono font-extrabold text-[#1A56DB]">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-cyan-100 text-cyan-800 border border-cyan-200 flex items-center gap-1">
                ...
                <div className="flex items-center gap-3">
                  <div className="text-right">
                    ...
                    <span className="text-base font-mono font-extrabold text-[#0891B2]">R$ 52,50 / paciente</span>
                  </div>
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 rounded-xl border transition-all cursor-pointer ${
                            isSelected
                              ? 'bg-cyan-50/70 border-[#0891B2] shadow-sm ring-2 ring-cyan-200'
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-5">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
                        ...
                        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 text-right">
                          ...
                          <span className="text-xl font-mono font-extrabold text-[#0891B2]">
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                          ...
                          <button
                            ...
                            className="p-3.5 rounded-xl border border-cyan-200 bg-cyan-50/50 hover:bg-cyan-100/70 text-left transition-all group disabled:opacity-50"
                          >
                            <div className="flex items-center justify-between mb-1.5">
                              <Package className="w-4 h-4 text-[#0891B2] group-hover:scale-110 transition-transform" />
                      ...
                      <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                        ...
                        <div className="space-y-1.5 text-xs">
                          ...
                          {currentPatient.itensPrescritos.map((item, idx) => (
                            <div key={idx} className="flex items-center justify-between text-cyan-700 font-medium">
                          ...
                          <div className="pt-2 border-t border-slate-200 flex items-center justify-between font-bold text-[#1E3A5F]">
                            ...
                            <span className="font-mono text-sm text-[#0891B2]">
                              R$ {currentPatient.custoAcumulado.toFixed(2)}
                            </span>
                          </div>
                        </div>
