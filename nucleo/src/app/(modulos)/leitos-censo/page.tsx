    ...
    <>
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Link
              aria-label="App de Tarefas (Hotelaria)"
              title="App de Tarefas (Hotelaria)"
              href="/tarefas"
            ...
            >
              ...
              <span className="hidden lg:inline">App de Tarefas (Hotelaria)</span>
            </Link>
          </div>
        }
      />
      ...
      <div className="flex flex-1 relative overflow-x-clip">
        <ModuloMenuLateral
          ...
          itens={menuItens}
          ativoId={secaoAtiva}
          onSelect={(id) => setSecaoAtiva(id as SecaoLeitos)}
